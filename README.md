...
func Linechart() {
	...
	//Preview generates a random html and opens it with the default browser
	err := f.Preview()
	if err != nil {
		panic(err)
	}
...
<html>
<head>
	<title>Linechart Example Frame</title>
...
<div id="content">
  <div class="row">
    <div id="header" class="column grid_12"><h1>Linechart Example Frame</h1></div>
  </div>
	
  	<div class="row graphrow">
  		<div class="column grid_12">
			<h3>Linechart Example</h3>
		<div id="linechartexample" style="width:100%; height:375px;">
	  </div>
	</div>
  </div>
</div>
  ...
  <script>eval("Linechart").plot("linechartexample", [{"date":"2011/07/23","thing":10,"thong":20,"whatevs":14},{"date":"2011/07/24","thing":12,"thong":24,"whatevs":24},{"date":"2011/07/24","thing":12,"thong":7,"whatevs":11}], {})</script>
